...
class MU_Lang extends CI_Lang {
	...
	***************************************************/
	...
	var $special = array (
		"accommodation","activities","booking","classification",
		"content","customize","extra_products","facilities",
		"feedbacks","festival","gallery","location","calendar",
		"login_admin","package","passenger","room",
		"subscribers","transportation","supplier","user",
		"ajaxController","menu","munich_admin","profile"
	);
