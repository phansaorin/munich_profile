                    ...
                    <div style="float:right;padding-bottom:13px;">
                       <?php
                        if ($this->session->userdata('hiddens')) {
                          ...
                          ?>
                         <a href="#">
                            <button class="btn-info btn-sm" data-toggle="modal" data-target=".contact_admin">Send Mail</button>
                           </a>
                           <?php $this->load->view(INCLUDE_FE_MODEL."contact_admin"); ?>
                      <?php }?>
                      <!-- end of sending mail -->
                      <a href="#">
                      <button class="btn-info btn-sm" data-toggle="modal" data-target=".addmorepassenger">More Passenger</button>
                       </a>
                       <?php $this->load->view(INCLUDE_FE_MODEL."upgrade_booking"); ?>
                       <a href="#">
                            <button class="btn-info btn-sm" data-toggle="modal" data-target=".upgrade_booking">Upgrade Booking</button>
                        </a>
                     </div>
