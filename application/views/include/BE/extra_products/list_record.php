...
<div class="row clearfix">
            ...
            <table class="table table-striped table-hover table-bordered" >
                ...
                <tr> 
                    ...
                    <th><?php echo anchor("extra_products/list_record/ID/" . $sort, "No"); ?></th>
                    <th><?php echo anchor("extra_products/list_record/Name/" . $sort, "Name"); ?></th>
                    <th>Image</th>
                    <th>Per Person</th>
                    <th><?php echo anchor("extra_products/list_record/Providerdate/" . $sort, "Provider Date"); ?></th>
                    <th><?php echo anchor("extra_products/list_record/Payeddate/" . $sort, "Paid Date"); ?></th>
                ...
                <?php if ($extraproduct->num_rows > 0) { ?>
                  <?php foreach ($extraproduct->result() as $data) { ?>
                        <tr>
                            <td>
