...
<div class="container-fluid clearfix">
    ...
    <div class="col-md-6 column top-action padding-top-action">
        <div class="btn-group">                         
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><?php echo anchor ('transportation/exportByPagePDF/'.$this->uri->segment(2),'Export data for this page','title="Print"');?></li>
            </ul>
        </div>
        <div class="btn-group">                     
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><?php echo anchor ('transportation/exportByPageExcel/'.$this->uri->segment(2),'Export data for this page','title="Print" class="error check_excel_print"');?></li>
            </ul>
        </div>
    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        <tbody class="tbl_body">    
            <?php if ($search_transportation->num_rows > 0) { ?>
              <?php foreach ($search_transportation->result() as $data) { ?>
        <tr>
            <td>
