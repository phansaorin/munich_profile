...
<table class="table_sub">
    <tr>
        ...
        <td>
        <?php $ativitiesName = array('name' =>'transportationName','value'=> set_value('transportationName'),'class' => 'form-control'); echo form_input($ativitiesName);?>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><label class="control-label">Arrival Date :</label></td>
        <td>
            <?php
                $Arrivaldate = array( 'id'=>'dps6','name' => 'txtArrivalDate', 'class' => 'form-control','data-date-format'=>'yyyy-mm-dd','style'=>'', 'value' => set_value('txtArrivalDate'));
    ...
    <tr>
        <td><label class="control-label">Hotel Contract: </label></td>
        <td>
