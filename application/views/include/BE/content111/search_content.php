...
<div>
  <div class="col-md-7 column search">
    <?php 
      if($this->session->userdata('search')){ $searchtitle = $this->session->userdata('search');}else{ $searchtitle = ""; }
...
<div class="container-fluid clearfix">
    <table class="table table-striped table-hover table-bordered">
        <tr> 
            ...
            <th><?php echo anchor("content/search_content/ID/".$sort, "ID"); ?></th>
            <th><?php echo anchor("content/search_content/Title/".$sort, "Title"); ?></th>
            <th>Text</th>
            <th>Layout</th>
...
?>
        <tr>
          ...
          <td><?php echo $value->con_title; ?></td>
          <td><?php echo $value->con_text; ?></td>
