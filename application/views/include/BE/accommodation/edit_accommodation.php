<?php  echo form_open('accommodation/edit_accommodation/'.$this->uri->segment(3), 'class="form-horizontal"'); ?>
...
<?php
        foreach ($get_accommodation->result() as $row) {
            ?>
    <div class="form-group">
        <label class="col-sm-2 control-label">Name <span class="require">*</span> :</label>
        <div class="col-sm-4">
            <?php
                $accommodationName = array('name' => 'old_accommodationName','value'=> $row->acc_name,'class' => 'form-control');
                echo form_input($accommodationName); 
                ?>
            <span style="color:red;"><?php echo form_error('old_accommodationName'); ?></span>
        </div>
        <button type="button" class="btn btn-primary btn-xs"  data-toggle="tooltip" data-placement="right" title="The name of Accommodation must be unique.">Note</button>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">Choice Item <span class="require">*</span> :</label>
        <div class="col-sm-2">
            <?php 
                echo form_dropdown('old_txtchoiceItem', $old_txtchoiceItem, $row->acc_choiceitem,'class="form-control"'); 
            ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <?php
                    $checkDate = array(); 
                    if($get_accommodation->num_rows() > 0){
                        foreach($get_accommodation->result() as $val){
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php 
                $txtBooking = array('name'=>'old_txtBooking', 'class' => 'form-control textarea', 'value' => $row->acc_bookingtext);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $txtEticket = array('name'=>'old_txtEticket', 'class' => 'form-control textarea', 'value' => $row->acc_texteticket); 
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?php
                $purchasePrice = array('name' => 'old_purchasePrice','class' => 'form-control', 'value' => $row->acc_purchaseprice);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?php
                $salePrice = array('name' => 'old_salePrice','class' => 'form-control','value' => $row->acc_saleprice);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?php
                $originalStock = array('name' => 'old_originalStock','class' => 'form-control', 'value' => $row->acc_originalstock);
                echo form_input($originalStock);
                echo form_hidden('old_originalStock', $row->acc_originalstock);
            ?>
        </div>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <?php
                $actualStock = array('name' => 'old_actualStock','class' => 'form-control', 'value'=> $row->acc_actualstock);
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Booking Contract with Accommodation Organizer :</label>
        <div class="col-sm-4">
            <div id="alert">
                <strong></strong>
                <?php
                    $contract = array('id'=>'dp1' ,'name' => 'old_contract', 'class' => 'form-control','data-date-format'=>'yyyy-mm-dd','style'=>'width:210px;', 'value' => $row->acc_organiserdate);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <strong></strong>
            <?php
                $payed = array( 'id'=>'dp2','name' => 'old_txtPayed', 'class' => 'form-control','data-date-format'=>'yyyy-mm-dd','style'=>'width:210px;', 'value' => $row->acc_payeddate);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php
                $deadline = array( 'id'=>'dp3','name' => 'old_txtDeadline', 'class' => 'form-control','data-date-format'=>'yyyy-mm-dd','style'=>'width:210px;', 'value' => $row->acc_deadline);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php 
                $txtAdmin = array('name' => 'old_txtAdmin', 'class' => 'form-control textarea', 'value' => $row->acc_admintext);
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <?php echo form_dropdown('old_txtStatus', $txtStatus,$row->acc_status ,'class="form-control"'); ?>
            <span style="color:red;"><?php echo form_error('old_txtStatus'); ?></span>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-10">
            <label class="control-label"> Sub Accommodation:</label>
            <div class="table-responsive">
                <table class="table table-bordered">
                <tr>
                    <th><input type="checkbox" name="check_id_subaccommodation" id="check_id_subaccommodation"></th>
                    <th>No</th>
                    <th>Sub Accommodation Name</th>
                    <th>Sub Accommodation Description</th>
                </tr>
                <?php
                    $checkbox = array(); 
                    if($tbSubAccExist->num_rows() > 0){
                        foreach($tbSubAccExist->result() as $val){
                            $checkbox[$val->subaccommodation_id] = $val->subaccommodation_id;
                        }
                    }
                ?>
                <?php foreach($tbSubAccommodation->result() as $data){?>
               <tr>
                <td>
                    <?php 
                        if(array_search($data->sub_acc_id, $checkbox) > 0){
                            echo form_checkbox(array('class' => 'check_checkbox', 'id' => 'check_id_subaccommodation', 'name' => 'check_id_subaccommodation[]','checked'=>TRUE),$data->sub_acc_id);                      
                        }else{
                            echo form_checkbox(array('class' => 'check_checkbox', 'id' => 'check_id_subaccommodation', 'name' => 'check_id_subaccommodation[]'),$data->sub_acc_id);                      
                        }  
                    ?>
                </td>
                <td><?php echo $data->sub_acc_id; ?></td>
                <td><?php echo $data->sub_acc_title; ?></td>
                <td><?php echo $data->sub_acc_value; ?></td>
                </tr>
                <?php } ?>
            </table> 
           </div>   
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        <?php 
            echo form_submit('edit_accommodation', 'Update',"class='btn btn-primary'");
            echo '  ';
			echo anchor('accommodation/list_record', form_button('btn_close', 'Cancel', 'class="btn btn-primary"'));
        ?>
    </div>
  </div>
<?php } ?>
