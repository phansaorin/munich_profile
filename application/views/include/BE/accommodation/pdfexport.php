<?php
//Additional values
$pdfFileName = 'export_accommodation.pdf';

tcpdf();
$obj_pdf = new TCPDF('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
$obj_pdf->SetCreator(PDF_CREATOR);
$title = "Accommodation data Export";
...
$content = '<table width="500" cellpadding="0" cellspacing="0" border="1" style="text-align:center; margin-top: 5px;">
        <thead>
                <tr bgcolor="#FFDEAD" color="black">
                    ...
                    <th><font size="11">Accommodation Name</font></th>
                    <th width="80"><font size="11">From Date</font></th>
                    <th width="50"><font size="11">To Date</font></th>
                    <th width="55"><font size="11">Location</font></th>
...
?>
        ...
        foreach ($accommodation as $data):
            $content .= '<tr><td  width="40">'.$id++.'</td>
                        ...
                        <td width="55">'.$data->lt_name.'</td>
                        <td width="55">'.$data->acc_purchaseprice.'</td>
                        <td width="55">'.$data->acc_saleprice.'</td>
                        <td width="55">'.$data->acc_originalstock.'</td>
                        <td width="55">'.$data->acc_actualstock.'</td></tr>';
            ?>
        <?php endforeach; 
        $content .= '<tbody></table>'; ?>
<?php
