...
<table class="table_sub">
    <tr>
        ...
        <td>
        <?php $ativitiesName = array('name' =>'activitiesName','value'=> set_value('activitiesName'),'class' => 'form-control'); echo form_input($ativitiesName);?>
        </td>
    </tr>
    <tr>
        <td><label class="control-label">Choice Item <span class="require">*</span> :</label></td>
        <td>
            <?php echo form_dropdown('txtchoiceItem', $txtchoiceItem, '','class="form-control"'); ?>
        </td>
    </tr>
    <tr>
