...
<div class="container-fluid clearfix">
    <div class="col-md-8 column search">
     <?php
        ...
        echo form_input(array('name' => 'search_customize_name','value' => set_value('search_name', $this->session->userdata('search_customize')), 'class' => 'form-control input-sm', 'placeholder' => 'Customize Name'));
        echo '</div> &nbsp;';
