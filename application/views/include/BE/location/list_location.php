...
<div class="col-md-12 column">
            <table class="table table-bordered">
                <tr> 
                    ...
                    <td><?php echo anchor("location/list_location/ID/" . $sort, "No"); ?></td>
                    <td><?php echo anchor("location/list_location/Name/" . $sort, "Locations"); ?></td>
                    <td>Action</td>
                </tr>	
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php  echo form_open_multipart('location/add_location', 'class="form-horizontal add_location"'); ?>
              ...
              <div class="form-group">
                          <label class="col-sm-4 control-label">Location Status:</label>
                          <div class="col-sm-7">
                              <?php 
                                  $option_lstatus = array('0'=> "Unpublish",'1'=>"Publish");
                                  echo form_dropdown('lstatus', $option_lstatus,'', 'class="form-control"'); 
                              ?>
                          </div>
                      </div>
              <div class="form-group">
