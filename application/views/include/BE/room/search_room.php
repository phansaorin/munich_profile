...
<div class="row">
            ...
            <table class="table table-striped table-hover table-bordered">
                  <tr> 
                    ...
                    <th><?php echo anchor("room/search_room/ID/" . $sort, "No"); ?></th>
                    <th><?php echo anchor("room/search_room/Name/" . $sort, "Room Name"); ?></th>
                    <th>Action</th>
                   
                </tr>	
                <?php if ($search_room->num_rows > 0) { ?>
                  <?php foreach ($search_room->result() as $data) { ?>
                        <tr>
                          <td>
