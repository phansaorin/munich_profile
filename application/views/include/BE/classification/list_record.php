    ...
    <div class="col-md-5 column top-action">
            ...
            <table class="table table-striped table-hover table-bordered">
                <tr> 
                    ...
                    <th><?php echo anchor("classification/list_record/ID/" . $sort, "No"); ?></th>
                    <th><?php echo anchor("classification/list_record/Name/" . $sort, "Classification Name"); ?></th>
                    <th><?php echo anchor("classification/list_record/Value/" . $sort, "Classification Value"); ?></th>
                    <th>Action</th>
                </tr>	
