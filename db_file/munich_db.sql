...
DROP TABLE IF EXISTS `customize_conjections`;
...
-- Dumping data for table munich_db.package_conjection: ~4 rows (approximately)
/*!40000 ALTER TABLE `package_conjection` DISABLE KEYS */;
INSERT INTO `package_conjection` (`pkcon_id`, `pkcon_start_date`, `pkcon_end_date`, `pkcon_description`, `pkcon_name`, `pkcon_actualstock`, `pkcon_originalstock`, `pkcon_purchaseprice`, `pkcon_saleprice`, `pk_accomodation`, `pk_activities`, `pk_transportation`, `pkconl_ftv_id`, `pkcon_lt_id`, `pkcon_status`, `pkcon_deleted`) VALUES
	(1, '2014-03-17', '2014-03-21', 'qwerw', 'Hello', 10, 10, 12, 14, NULL, NULL, NULL, 1, 4, 1, 0),
	(2, '2014-03-17', '2014-03-21', 'qwerw', 'Hello', 10, 10, 12, 14, NULL, NULL, NULL, 1, 4, 1, 0),
	(3, '2014-03-17', '2014-03-21', 'qwerw', 'Hello', 10, 10, 12, 14, NULL, NULL, NULL, 1, 4, 1, 0),
	(4, '2014-03-17', '2014-03-21', 'qwerw', 'Hello', 10, 10, 12, 14, NULL, NULL, NULL, 1, 4, 1, 0);
